...
{
    internal class FindFacilityQuery : IQuery<FacilityContext, Contracts.Models.Facility>
    {
        ...
        public async Task<Contracts.Models.Facility> ExecuteAsync(FacilityContext model)
        {
